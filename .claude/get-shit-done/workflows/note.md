...
- **Global scope**: `/Users/tanakalucky/Work/10.programming/20.private_develop/10.sample-project/plotted/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/tanakalucky/Work/10.programming/20.private_develop/10.sample-project/plotted/.claude/notes/`)
...
2. Glob `/Users/tanakalucky/Work/10.programming/20.private_develop/10.sample-project/plotted/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/tanakalucky/Work/10.programming/20.private_develop/10.sample-project/plotted/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/tanakalucky/Work/10.programming/20.private_develop/10.sample-project/plotted/.claude/notes/` — works in any directory
